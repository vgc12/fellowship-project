...
import Vector3InputComponent from "@/components/ui/vector3-input-component.tsx";
    ...
    return (
        <li className={" fade-in border-neutral-600 border-4 rounded-md  mt-2"}>
            <div className={"bg-transparent p-4 text-center"}>
                ...
                <div className={"text-center"}>
                    <Vector3InputComponent label={"Position"} values={props.object.transform.position.toArray}
                                           onChange={
                                               (val, axis) => {
                                                   switch (axis) {
                                                       case 'X':
                    ...
                    <Vector3InputComponent label={"Rotation"} values={props.object.transform.rotation.toArray}
                                           onChange={
                                               (val, axis) => {
                                                   switch (axis) {
                                                       case 'X':
