...
$areaCode = substr($_POST['phone-num'], 0, 3);

// area code dictionary mapping area codes to cities
// see "are-code-array-formatter.php" for how this array was created
$areaCodeToCity = [
    "201" => "Jersey City, NJ ",
...
// See if the area code is in the dictionary
if (array_key_exists($areaCode, $areaCodeToCity)) {
    echo "<h1>City for area code $areaCode: " . $areaCodeToCity[$areaCode] . "</h1>";
} else {
    echo "<h1>Area code $areaCode not found.</h1>";
}